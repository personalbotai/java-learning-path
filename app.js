...
const lessons = [
    {
        ...
        "description": "<p><strong>Abstract Classes</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Access Modifiers</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Apa itu Java?</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        "id": 4,
        "title": "4. Arrays",
        "description": "<p><strong>Arrays</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Break Continue</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        "id": 6,
        "title": "6. Class Dasar",
        "description": "<p><strong>Class Dasar</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Enum Dan Constants</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Exceptions Basics</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        "id": 9,
        "title": "9. Hello World",
        "description": "<p><strong>Hello World</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>If/Else dan Switch</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Inheritance</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Input Output</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Instalasi Java</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Interfaces Basic</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Intro Collections</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>List Dan Arraylist</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Loops Basic</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Map Dan Hashmap</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Optional Dan Streams Dasar</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Polymorphism</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Queue Dan Deque</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Set Dan Hashset</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Struktur Program</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Throw Dan Throws</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Try Catch Finally</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Type Casting</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Type Inference</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Variabel Tipe Data</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Void Dan Special Types</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
    ...
    },
    {
        ...
        "description": "<p><strong>Wrapper Classes</strong> adalah materi penting dalam pemrograman Java.</p>\n<h4>🎯 Yang Dipelajari:</h4>\n<ul><li>Konsep dan sintaks Java</li><li>OOP principles dan best practices</li><li>Contoh kode dan implementasi</li></ul>\n<h4>💻 Praktik:</h4>\n<ul><li>Tulis kode di editor</li><li>Jalankan dan lihat output</li><li>Quiz untuk uji pemahaman</li></ul>",
